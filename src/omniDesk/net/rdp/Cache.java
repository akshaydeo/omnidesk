...
public class Cache {
	...
	private ColorModel256[] colourcache = new ColorModel256[RDPCACHE_COLOURMAPSIZE];
     ...
     */
	public ColorModel256 get_colourmap(int cache_id) throws RdesktopException {
		ColorModel256 map = null;
     ...
     * @throws RdesktopException
     */
	public void put_colourmap(int cache_id, ColorModel256 map)
			throws RdesktopException {
		if (cache_id < colourcache.length)
	...
	public void putBitmap(int cache_id, int cache_idx, Bitmap bitmap, int stamp)
		...
		System.out.println("PUT BITMAP CAACHE CALLED");
        //Bitmap old;
	...
	public void putFont(Glyph glyph) throws RdesktopException {
		System.out.println("PUT font CAACHE CALLED");		
	...
	public void putText(int cache_id, DataBlob entry) throws RdesktopException {
		System.out.println("PUT TEXT CAACHE CALLED");
		if (cache_id < textcache.length) {
	...
	public void putDesktop(int offset, int cx, int cy, int[] data) throws RdesktopException {
		...
		System.out.println("PUT dESKTOP CAACHE CALLED");
		int length = cx * cy;
		int pdata = 0;
