...
import omniDesk.net.rdp.crypto.BlockMessageDigest;
import omniDesk.net.rdp.crypto.CryptoException;
import omniDesk.net.rdp.crypto.MD5;
import omniDesk.net.rdp.crypto.RC4;
import omniDesk.net.rdp.crypto.SHA1;
...
public class Secure {
	...
	public RdpPacket_Localised sendMcsData() {
		...
		// Client information
	//	Log.d("secure.java","value of use_RDP5= " + Options.use_rdp5);
		...
		buffer.setLittleEndian16(0xca01); //8 bpp
