...
public class Options {
	...
	public static int width = 800; // -g widthxheight //amd -> to reduce the size of the image to be rendered
	...
	public static int server_bpp = 16;//24;							// Bits per pixel
   ...
   // public static DirectColorModel colour_model = new DirectColorModel(24,0xFF0000,0x00FF00,0x0000FF);
    ...
    //    colour_model = new DirectColorModel(24,0xFF0000,0x00FF00,0x0000FF);neer
	}
	...
	public static boolean disable_wallpaper=true;		// true when wallpaper disabled
	public static boolean disable_theming=true;
}
